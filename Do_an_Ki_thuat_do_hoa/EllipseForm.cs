...
namespace Do_an_Ki_thuat_do_hoa
{
    public partial class EllipseForm : Form
    {
        ...
        private void ok_Click(object sender, EventArgs e)
        {
            ...
            ell = new Ellipse(new Point(int.Parse(textBox_X1.Text)+50, -int.Parse(textBox_Y1.Text)+50), new Point(int.Parse(textBox_X2.Text)+50, -int.Parse(textBox_Y2.Text)+50));
            this.Close();
        }
